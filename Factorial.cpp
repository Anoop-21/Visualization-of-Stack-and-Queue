...
void simple_queue() {
	...
	drawString(40, 6, 0, GLUT_BITMAP_HELVETICA_18, back);
  ...
  //find the length of the number
    ...
    sprintf(nchar, "%d", item);
      ...
      //  top_pointer[]=key;
		...
		drawString(60, stk_top_ptr_pos - 10, 0, GLUT_BITMAP_HELVETICA_18, nchar);
